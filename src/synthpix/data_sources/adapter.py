...
class GrainSchedulerAdapter(SchedulerProtocol):
    ...
    def get_flow_fields_shape(self) -> tuple[int, int, int]:
        ...
        if self._cached_shape is None:
            ...
            try:
                ...
                # If the loader is empty, we propagate StopIteration so the caller knows it's empty.
                raise
    ...
    def get_batch(self, batch_size: int) -> SchedulerData:
        ...
        try:
            ...
            raise StopIteration("Grain DataLoader exhausted.")
