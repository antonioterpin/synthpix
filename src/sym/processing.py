...
def input_check_gen_img_from_flow(
    ...
    if VERBOSE:
        ...
        print(f"Probability of hiding particles in image 2: {p_hide_img2}")
        print(f"Particle diameter range: {diameter_range}")
        print(f"Intensity range: {intensity_range}")
        print(f"Correlation coefficient range: {rho_range}")
