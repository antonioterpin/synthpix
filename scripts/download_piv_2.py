...
def download_file(url, output_path):
    ...
    try:
        # Check if we can resume? complex. Just download.
...
def process_tfrecord(tfrecord_path, out_dir):
    ...
    for raw_record in dataset:
        try:
            ...
            # Decode target -> I0, I1
            # Based on inspection: 524288 bytes = 131072 floats = 256*256*2
            try:
            ...
            # Ensure shapes for .mat (usually usually we want H,W for images and H,W,2 for flow)
            # convert.py used I0 shape (256, 256)
            # .mat often expects specific shape.
